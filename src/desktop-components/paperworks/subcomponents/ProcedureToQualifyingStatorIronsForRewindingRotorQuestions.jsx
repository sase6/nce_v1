  ...
  return (
    <div>
      <div className={`${sheetName}-rotor-info`}>
        <TextField InputLabelProps={{shrink: true}} value={rotorNumber || ''} variant='standard' label='ROTOR #:' sx={{width: '300px'}} onChange={(e) => setRotorNumber(e.target.value)}/>
        <div>
        ...
        <TextField InputLabelProps={{shrink: true}} variant='standard' label='WHO IS WINDING?:' sx={{width: '300px'}} value={whoIsWinding || ""} onChange={(e) => setWhoIsWinding(e.target.value)}/>
      </div>
